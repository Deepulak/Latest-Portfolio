      ...
      >
        ...
        <v-card v-if="project.dialog">
          ...
          <v-card-text>
            ...
            <v-chip color="#ff3a3f" text-color="white">{{project.tech.tech1}}</v-chip>
            <v-chip color="#ff3a3f" text-color="white">{{project.tech.tech2}}</v-chip>
            <v-chip color="#ff3a3f" text-color="white">{{project.tech.tech3}}</v-chip>
            <v-chip color="#ff3a3f" text-color="white">{{project.tech.tech4}}</v-chip>
          </v-card-text>
          <v-card-actions>
            <v-btn flat large dark color="#ff3a3f" :href="project.git" target="_blank">
              <v-icon left>fab fa-github</v-icon>GitHub
            </v-btn>
            <v-btn large flat dark color="#ff3a3f" :href="project.demo" target="_blank">
  ...
  metaInfo: {
    ...
    meta: [
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        name: "description",
        content:
          "Dee's Web Portfolio Vue Vue.js Nuxt Nuxt.js HTML CSS Vuetify Axios GraphQL JavaScript Web Developer Front-End Frontend Designer App Responsive"
      },
      { charset: "utf-8" },
